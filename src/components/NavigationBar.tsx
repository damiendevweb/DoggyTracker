...
export const NavigationBar = () => {
  ...
  return (
    <header className="sticky w-full top-0 z-50">
      <nav className="bg-bg/80 backdrop-blur-xl border-b border-border">
        <div className="flex items-center justify-between max-w-7xl mx-auto px-5 h-14">
          <Link to="/" className="flex items-center gap-2 group">
            <span className="text-sm">🐾</span>
            <span className="text-sm font-semibold text-text-primary tracking-tight" style={{ fontFamily: "'Unbounded', sans-serif" }}>
              Où est Médor ?
            </span>
          </Link>

          <div className="flex items-center gap-1.5">
            <div className="hidden lg:flex items-center gap-0.5 mr-4">
              {[
