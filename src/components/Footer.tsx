        ...
        <footer className="bg-yellow-100">
            <div className="max-w-7xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
                    <div>
                        <h3 className="mb-6 text-sm font-semibold text-dark-grey uppercase ">Company</h3>
                    ...
                    <div>
                        <h3 className="mb-6 text-sm font-semibold text-dark-grey uppercase ">Help center</h3>
                        <ul className="text-black ">
                            <li className="mb-4">
                    ...
                    <div>
                        <h3 className="mb-6 text-sm font-semibold text-dark-grey uppercase ">Legal</h3>
                        <ul className="text-black ">
                            <li className="mb-4">
                    ...
                    <div>
                        <h3 className="mb-6 text-sm font-semibold text-dark-grey uppercase ">Download</h3>
                        <ul className="text-black ">
                            <li className="mb-4">
                ...
                <div className="text-center">
                    <span className="block text-sm text-center text-black ">© 2026 Où est Médor. All Rights Reserved.
                    </span>
                    <ul className="flex justify-center mt-5 space-x-5">
                        <li>
                            <a href="#" className="text-black hover:text-dark-grey">
